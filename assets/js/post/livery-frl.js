    ...
    // === DATA POST ===
    const posts = [
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Judul", author: "Authoer", dateLiv: "2025-11-10", typeCar: "Altezza", folder: "liv", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL OROK SAKIT HATI", author: "ARS", dateLiv: "2025-11-17", typeCar: "S15", folder: "liv82", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL CAPER HENTAI", author: "ARS X RAFF", dateLiv: "2025-11-10", typeCar: "S15", folder: "liv78", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "CIVIC TYPE R BLUE LIMITED", author: "ARS", dateLiv: "2025-11-12", typeCar: "Altezza", folder: "liv77", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "TRIBAL LIMITED", author: "ARS", dateLiv: "2025-11-14", typeCar: "Altezza", folder: "liv76", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL SPECIAL 300 P", author: "ARS", dateLiv: "2025-11-10", typeCar: "Altezza", folder: "liv73", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POLOSAN", author: "ARS", dateLiv: "2025-11-07", typeCar: "Altezza", folder: "liv54", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POWER F", author: "ARS", dateLiv: "2025-11-06", typeCar: "Altezza", folder: "liv53", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "ARS", dateLiv: "2025-11-06", typeCar: "E36", folder: "liv49", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW F30 MODIFIED", author: "ARS", dateLiv: "2025-11-03", typeCar: "Altezza", folder: "liv48", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "ARS", dateLiv: "2025-11-02", typeCar: "Altezza", folder: "liv43", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "Rimex ARS", dateLiv: "2025-11-02", typeCar: "Altezza", folder: "liv40", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "ARS", dateLiv: "2025-11-02", typeCar: "S15", folder: "liv39", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "Nissan Silvia Libertywalk", author: "JDM Automotive Society", dateLiv: "2025-10-30", typeCar: "Altezza", folder: "liv38", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "Tribal", author: "PSKN SENYAP", dateLiv: "2025-10-31", typeCar: "Altezza", folder: "liv32", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "Tribal AGS JAYA", author: "AGZ", dateLiv: "2025-10-30", typeCar: "Altezza", folder: "liv28", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "Nissan Silvia S15 LBWK (BlackFish) LIMITED EDITION", author: "Admin #2 JDM Automotive Society", dateLiv: "2025-10-30", typeCar: "S15", folder: "liv26", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "SPECIAL 300 P LIMITED", author: "PSKN SENYAP", dateLiv: "2025-10-30", typeCar: "Altezza", folder: "liv24", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "SPECIAL 200 P", author: "PSKN SENYAP", dateLiv: "2025-10-26", typeCar: "Altezza", folder: "liv21", body: "body.json", window: "window.json", aspekRasio: "16/9" },
...
function _0x45a5(){const _0x26da34=['ARDAIMUTZ','4266WlkOuO','283486wwBQbl','156wmUtOI','102103mtNEMj','24ZxMEzx','1790ogRjVF','1752264ckQryf','768igJJVk','1386846TvneNT','212820jLgMpN'];_0x45a5=function(){return _0x26da34;};return _0x45a5();}const _0x50f956=_0x52be;function _0x52be(_0x217845,_0x33f337){const _0x45a53a=_0x45a5();return _0x52be=function(_0x52be27,_0x51bf25){_0x52be27=_0x52be27-0x1d4;let _0x29bd6e=_0x45a53a[_0x52be27];return _0x29bd6e;},_0x52be(_0x217845,_0x33f337);}(function(_0x4187b8,_0xc9a25c){const _0x4b77c4=_0x52be,_0x5c061a=_0x4187b8();while(!![]){try{const _0x1cdd6a=-parseInt(_0x4b77c4(0x1d5))/0x1+-parseInt(_0x4b77c4(0x1d9))/0x2*(-parseInt(_0x4b77c4(0x1d4))/0x3)+-parseInt(_0x4b77c4(0x1d6))/0x4*(-parseInt(_0x4b77c4(0x1db))/0x5)+parseInt(_0x4b77c4(0x1da))/0x6+parseInt(_0x4b77c4(0x1de))/0x7+-parseInt(_0x4b77c4(0x1d8))/0x8+-parseInt(_0x4b77c4(0x1dd))/0x9*(parseInt(_0x4b77c4(0x1d7))/0xa);if(_0x1cdd6a===_0xc9a25c)break;else _0x5c061a['push'](_0x5c061a['shift']());}catch(_0x49770c){_0x5c061a['push'](_0x5c061a['shift']());}}}(_0x45a5,0x226d1));const validTokens=['AGSJAYA','ARDAGANTENG',_0x50f956(0x1dc),'ARDASTYLEGANZ'];
